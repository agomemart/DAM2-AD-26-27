...
public class EjemploSerializacionHerencia {
    public static void main(String[] args) {
        try (var in = new ObjectInputStream(new FileInputStream("perros.dat"))) {
        ...
        try {
            ...
            ObjectOutputStream salida = new ObjectOutputStream(new FileOutputStream("perros.dat"));
...
class Animal implements Serializable {
    private static final long serialVersionUID = 1L; // Asegura la compatibilidad de
    String nombre;
