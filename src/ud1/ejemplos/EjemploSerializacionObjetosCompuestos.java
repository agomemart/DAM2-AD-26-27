...
public class EjemploSerializacionObjetosCompuestos {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ObjectOutputStream salida = new ObjectOutputStream(new FileOutputStream("rectangulos.dat"));
        ...
        ObjectInputStream entrada = new ObjectInputStream(new FileInputStream("rectangulos.dat"));
        try {
            while (true) {
